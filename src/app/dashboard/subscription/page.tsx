...
export default function SubscriptionPage() {
  ...
  return (
    <div
      className={`space-y-4 sm:space-y-6 px-4 sm:px-0 ${isRTL ? "text-right" : ""}`}
      dir={isRTL ? "rtl" : "ltr"}
    >
      <div>
      ...
      <div className="bg-white dark:bg-[#1e293b] rounded-lg sm:rounded-xl shadow p-4 sm:p-8 border border-gray-200 dark:border-slate-800">
